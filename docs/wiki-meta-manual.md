...
├── 소개.md                    # ✅ 작성 완료
├── 시작하기.md                # ✅ 작성 완료
├── 화상키보드-기본.md          # 키보드 기본 조작
├── 한국어-입력.md             # 한글 조합 입력, 가/A 토글
...
| W03 | 화상키보드-기본 | ⬜ 대기 | | 키보드 기본 조작, 창 이동/크기, 헤더 접기 |
| W04 | 한국어-입력 | ⬜ 대기 | | 한글 조합, 가/A 토글, QuietEnglish |
| W05 | 자동완성 | ⬜ 대기 | | 제안 바, 초성 검색, 빅그램, 사용자 사전 |
| W06 | 수식자-고정 | ⬜ 대기 | | Sticky Keys 3단계, UI 인디케이터 |
| W07 | 체류클릭 | ⬜ 대기 | | Dwell Click 설정, 프로그레스 링 |
| W08 | 키-반복 | ⬜ 대기 | | Key Repeat 지연/간격 설정 |
| W09 | 레이아웃-커스터마이징 | ⬜ 대기 | | JSON 구조, 편집기 사용법 |
| W10 | 앱별-레이아웃 | ⬜ 대기 | | 프로필 자동 전환 설정 |
| W11 | 액션-키 | ⬜ 대기 | | 10종 키 액션 종류별 설명 |
| W12 | 이모지 | ⬜ 대기 | | 카테고리, 전송 방식 |
| W13 | 클립보드-히스토리 | ⬜ 대기 | | 히스토리 패널, 붙여넣기 |
| W14 | 설정 | ⬜ 대기 | | 설정 패널 전체 가이드 |
| W15 | 테마와-외관 | ⬜ 대기 | | 테마, 투명도, 자동 페이딩 |
| W16 | 시스템-트레이 | ⬜ 대기 | | 트레이 아이콘, 컨텍스트 메뉴, 전역 단축키 |
| W17 | 업데이트 | ⬜ 대기 | | 자동 업데이트 흐름 |
| W18 | 관리자-권한 | ⬜ 대기 | | 권한 모드, 제한사항 |
| W19 | 문제해결 | ⬜ 대기 | | FAQ, 트러블슈팅 |
| W20 | 단축키-모음 | ⬜ 대기 | | 전체 단축키 정리표 |
| W21 | Home.md 갱신 | ⬜ 대기 | | Home.md | 모든 페이지 완료 후 목차 갱신 |
